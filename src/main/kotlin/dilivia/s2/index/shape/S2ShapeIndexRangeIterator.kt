 ...
 * @since 1.0
 */
class S2ShapeIndexRangeIterator(index: S2ShapeIndex) {

    private val iterator: S2ShapeIndexCellIterator = index.cellIterator(InitialPosition.BEGIN)
    ...
    fun seekTo(target: S2ShapeIndexRangeIterator) {
    ...
    fun seekBeyond(target: S2ShapeIndexRangeIterator) {
