...
object S2Measures {
    ...
    fun angle(a: S2Point, b: S2Point, c: S2Point): Double {
        ...
        return S2Point.robustCrossProd(a, b).angle(S2Point.robustCrossProd(c, b))
    }
    ...
    fun turnAngle(a: S2Point, b: S2Point, c: S2Point): Double {
        ...
        val angle = S2Point.robustCrossProd(a, b).angle(S2Point.robustCrossProd(b, c))
    ...
    fun area(a: S2Point, b: S2Point, c: S2Point): Double {
        Assertions.assert { S2Point.isUnitLength(a) }
        Assertions.assert { S2Point.isUnitLength(b) }
        Assertions.assert { S2Point.isUnitLength(c) }
    ...
    fun girardArea(a: S2Point, b: S2Point, c: S2Point): Double {
        ...
        val bc = S2Point.robustCrossProd(b, c)
        val ac = S2Point.robustCrossProd(a, c)
